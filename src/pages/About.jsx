  ...
  return (
    <div className="min-h-screen bg-base-100">
      ...
      <section className="hero min-h-[60vh] relative overflow-hidden bg-base-200">
        ...
        <div className="hero-content flex-col lg:flex-row gap-8 max-w-7xl mx-auto px-4 py-20">
          {/* Image Section */}
          <motion.div
          ...
          >
            <div className="relative rounded-2xl shadow-2xl overflow-hidden">
              <img
                ...
                className="w-full h-auto max-w-md lg:max-w-lg xl:max-w-xl object-cover"
              />
          ...
          >
            ...
            <p className="text-xl md:text-2xl leading-relaxed mb-8 text-base-content/90">
              This page shows the paintings of famous artists.<br className="hidden md:block" />
      ...
      <AnimatePresence>
        {showDetails && (
          <motion.section
            ...
            className="overflow-hidden bg-base-200 py-16"
          >
            <div className="container mx-auto px-4">
              <div className="max-w-5xl mx-auto">
                <motion.div
                  ...
                  className="card bg-base-100 shadow-2xl rounded-2xl p-6 md:p-10 lg:p-12"
                >
                  <h1 className="text-4xl md:text-5xl font-bold mb-10 text-center bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                    About Us
                  </h1>
                  ...
                  <div className="mb-12 space-y-6">
                    <div className="divider">
                      <h2 className="text-2xl md:text-3xl font-bold uppercase tracking-wide">Our Mission</h2>
                    </div>
                    <h3 className="text-2xl md:text-3xl font-bold mb-6 text-primary">
                      Our journey starts with U.
                    </h3>
                    
                    <div className="space-y-5 text-base md:text-lg leading-relaxed prose prose-lg max-w-none">
                  ...
                  <div className="mb-8 space-y-6">
                    <div className="divider">
                      <h2 className="text-2xl md:text-3xl font-bold uppercase tracking-wide">Our Founders</h2>
                    </div>
                    <blockquote className="border-l-4 border-primary pl-6 py-4 bg-base-200 rounded-r-lg">
                      <p className="text-xl md:text-2xl font-semibold italic text-base-content/90">
                  ...
                  {/* Collapse Button */}
                  <div className="text-center mt-10 pt-8 border-t border-base-300">
                    <button
              ...
              {[
                ...
                >
                  <div className="card-body text-center items-center">
                    ...
                    <h3 className="card-title text-xl mb-2">{member.title}</h3>
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-20 bg-gradient-to-br from-primary/10 via-base-100 to-secondary/10">
